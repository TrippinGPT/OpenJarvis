...
from openjarvis.server.relay_bridge_routes import router as relay_bridge_router
from openjarvis.server.relay_voice_routes import router as relay_voice_router
...
def create_app(
    ...
    *,
    ...
    app.include_router(relay_bridge_router)
    app.include_router(relay_voice_router)
