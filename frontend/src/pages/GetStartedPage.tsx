...
const PLATFORMS: Platform[] = [
  {
    ...
    file: 'Trippin AI Relay_aarch64.dmg',
    icon: Apple,
  },
  {
    id: 'mac-intel',
  ...
  },
  {
    ...
    file: 'Trippin AI Relay_x64-setup.msi',
    icon: Monitor,
  },
  {
    id: 'linux-deb',
    ...
    file: 'Trippin AI Relay_amd64.deb',
    icon: Terminal,
  },
  {
    id: 'linux-rpm',
    ...
    file: 'Trippin AI Relay_x86_64.rpm',
    icon: Terminal,
  },
];
